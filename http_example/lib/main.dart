...
class _HttpAppState extends State<HttpApp> {
  ...
  Future<String> getJSONData() async {
    ...
    var encodedURL = Uri.encodeComponent(url).toString();
    print(encodedURL);
    var response = await http.get(Uri.parse(url), headers: {'Authorization' : "KakaoAK 13f79c1bc6208b75088f9dc02c84cafa"});
