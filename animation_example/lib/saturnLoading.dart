...
class SaturnLoading extends StatefulWidget {
  ...
  void start() => _SaturnLoadingState().start();
  void stop() => _SaturnLoadingState().stop();
...
class _SaturnLoadingState extends State<SaturnLoading> with SingleTickerProviderStateMixin {
  ...
  void stop() =>_animationController.stop(canceled: true);
  void start() => _animationController.repeat();
